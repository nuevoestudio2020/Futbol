...
namespace Futbol
{
    public partial class TotalCampeonatos : Form
    {
        public TotalCampeonatos()
        {
            InitializeComponent();
        }
        ...
        private void TotalCampeonatos_Load(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        private void txtBusqueda_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                sql_con.Open();
                sql_cmd = sql_con.CreateCommand();
                string CommandText = "select count(CODIGO) As Campeonatos_Totales, sum(Valor) As Total_Recaudado, Fecha from campeonatos where FECHA like ('" + txtBusqueda.Text + "%')";
