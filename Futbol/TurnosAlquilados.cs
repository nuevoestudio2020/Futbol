...
namespace Futbol
{
    public partial class TurnosAlquilados : Form
    {
        public TurnosAlquilados()
        {
            InitializeComponent();
        }
        ...
        private void TurnosAlquilados_Load(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        private void txtBusqueda_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                sql_con.Open();
                sql_cmd = sql_con.CreateCommand();
                string CommandText = "select count(CODIGO) As Turnos_Alquilados_Totales, sum(Valor) As Total_Recaudado, Fecha from turnos where FECHA like ('" + txtBusqueda.Text + "%')";
